...
class Project2:
    ...
    def __init__(self):
        ...
        #model.save('minthick.h5')                               ### 파일 이름 지정
                        
        model = load_model('minthick.h5')                         ### 파일 이름 지정
    ...
    def graf(self, model, testin, testou):
        ...
        #d.to_csv('C:/Users/keuntae/Desktop/dnn.csv')
    ...
    def RBF(self, nOarr, nlarr, testin, testou):
        ...
        svr = SVR(kernel='rbf', C=30, gamma='auto')
        y_rbf = svr.fit(x, y)
        ...
        svr_poly = SVR(kernel='poly', C=1e4, degree=4, gamma = 'auto')
